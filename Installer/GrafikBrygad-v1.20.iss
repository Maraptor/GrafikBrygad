...
;         veolia.png
;   Installer\
;     GrafikBrygad-v1.20.iss   <-- ten plik
;
; WAŻNE:
; AppId pozostaje IDENTYCZNY jak w v1.19.
; Dzięki temu instalator v1.20 aktualizuje istniejącą instalację.
; ============================================================
...
OutputDir=Output
OutputBaseFilename=GrafikBrygad-v1.20-Setup

VersionInfoVersion=1.20.0.0
VersionInfoProductVersion=1.20
